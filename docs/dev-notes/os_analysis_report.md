...
- **Solution & Project Definitions**:
  - [GigaClaw.slnx](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.slnx)
...
- **Core Automation Engine & Domain Models** (`GigaClaw.Core/`):
  - [AutomationEngine.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Automation/AutomationEngine.cs)
  - [ClaudeRunner.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Automation/ClaudeRunner.cs)
  - [ClaudeStreamPump.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Automation/ClaudeStreamPump.cs)
  - [RunStateManager.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Automation/RunStateManager.cs)
...
- **Data Persistence & Database** (`GigaClaw.Core/Data/`):
  - [TodoDbContext.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Data/TodoDbContext.cs) (SQLite via EF Core)
  - [RegistryDbContext.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Data/RegistryDbContext.cs)
- **Services & Helpers**:
  - [ProjectService.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Services/ProjectService.cs)
  - [TicketService.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Services/TicketService.cs)
  - [ShellResolver.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Services/ShellResolver.cs) (cross-platform PATH detection for `pwsh` / `powershell` / `sh`)
  - [IFolderPicker.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Platform/IFolderPicker.cs)
- **Web UI & REST API** (`GigaClaw.Web/`):
  - [Program.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Web/Program.cs)
...
- **Scripts**:
  - [run.sh](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/run.sh): POSIX shell script used to run the app on macOS (and Linux).
...
- [WindowsFolderPicker.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Platform/WindowsFolderPicker.cs): Implements `IFolderPicker` using PowerShell and `System.Windows.Forms.FolderBrowserDialog`. Safe to remove on macOS (the UI automatically hides folder browsing if `IFolderPicker` is unregistered).
- [ProcessJobObject.cs](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/GigaClaw.Core/Automation/ProcessJobObject.cs): Encapsulates Win32 Job Objects via `kernel32.dll` P/Invoke (`CreateJobObject`, `AssignProcessToJobObject`) to ensure subprocess cleanup. On non-Windows OS, `ProcessJobObject.TryCreateAndAssign` returns `null` and falls back to standard `.Kill(true)`.
- [run.bat](file:///Users/zabalp1/Documents/Development/Github%20Repos/GigaClaw/run.bat): Windows CMD batch file launcher.
