...
For a requested **Product Review**, these points also require an explicit evaluation method, a clear
line between direct experience and sourced evidence, material pros/cons and limitations, value and
alternatives, audience fit, and affiliate/sponsorship disclosure. Invented hands-on testing,
unsupported specifications, or an omitted material relationship is a P0 trust failure.
