...
public sealed class TeamSeedStoreTests
{
    ...
    public async Task NewProject_SeedsTheBuiltInRosterOnFirstDefinitionCall()
    {
        ...
        // C8 added parallel-review to the roster: 10 built-ins now seed.
    ...
    public async Task Seed_IsIdempotent()
    {
        ...
        Assert.Empty(second);
        Assert.Equal(10, (await sut.Teams.ListDefinitionsAsync(sut.Slug)).Count);
    }
    ...
    public async Task ExistingProjectDb_MigratesWithoutLosingDefinitionsRunsOrTickets()
    {
        ...
        // Nine of the ten built-ins land; software-engineering is the owner's and is not one of them.
        Assert.Equal(9, touched.Count);
        ...
        Assert.Equal(11, await migrated.TeamDefinitions.CountAsync());
