...
builder.Services.AddSingleton<GigaClaw.Core.Automation.Runners.AgentRunnerRouter>();
builder.Services.AddSingleton<GigaClaw.Core.Automation.Runners.IAgentRunner>(
    sp => sp.GetRequiredService<GigaClaw.Core.Automation.Runners.AgentRunnerRouter>());
