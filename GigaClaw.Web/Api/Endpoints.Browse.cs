...
public static partial class Endpoints
{
    private static void MapBrowse(RouteGroupBuilder api)
    {
        ...
        api.MapGet("/browse/capabilities", ([Microsoft.AspNetCore.Mvc.FromServices] GigaClaw.Core.Platform.IFolderPicker? picker) =>
            Results.Ok(new { folderPicker = picker?.IsAvailable == true }))
            .WithTags("Browse");

        api.MapPost("/browse/folder", async (BrowseFolderRequest? req, [Microsoft.AspNetCore.Mvc.FromServices] GigaClaw.Core.Platform.IFolderPicker? picker, CancellationToken ct) =>
        {
